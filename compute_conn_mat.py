...
matrices_output = os.path.join(data_path, 'derivatives/destrieux_connectivity_matrices')
...
for subject in tqdm.tqdm(subjects):
    try:
        print(f"Computing conn matrix for subject {subject}")
        conn_matrix = dataset.get_conn_matrix(subject = subject, task = 'rest', output_space = 'MNI152NLin2009cAsym:res-2', parcellation = "destrieux", bold_tr = 0.801, save = True, save_to = matrices_output)
