...
for subject in tqdm.tqdm(subjects):
    ...
    wb_surf_resample_cmd_L,_,_ = parse_wb_surf_resample(subject, data_path, new_deformed_sphere_L, surf_type, "lh", output_nat_surf_L)
    wb_surf_resample_cmd_R,_,_ = parse_wb_surf_resample(subject, data_path, new_deformed_sphere_R, surf_type, "rh", output_nat_surf_R)
