...
grad2L[np.where(grad2L > np.percentile(grad2L, 10))[0]] = np.nan
grad2R = grads[1][32492:]
grad2R[np.where(grad2R > np.percentile(grad2R, 10))[0]] = np.nan
...
temp_zone_indR = np.where(fsLR_labels_R != 5)[0]
